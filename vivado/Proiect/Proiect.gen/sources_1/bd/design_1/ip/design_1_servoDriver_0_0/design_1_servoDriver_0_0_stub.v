...
module design_1_servoDriver_0_0(clk, reset, angle, toMotor, potentiometer, sw, btn)
/* synthesis syn_black_box black_box_pad_pin="reset,angle[7:0],toMotor,potentiometer,sw[3:0],btn[3:0]" */
